function showEditContactOverlay() {
  ...
  <div class="editContactOverlay">
        ...
        ></a></div>
          ...
          <div>
            <input type="email" placeholder="Email" class="formInput" requiered /><svg class="mailIconEditOverlay" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div>
            <input type="tel" placeholder="Phone" class="formInput" requiered /><svg class="phoneIconEditOverlay" width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
